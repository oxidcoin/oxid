...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("OXID");
    case mBTC: return QString("mOXID");
    case uBTC: return QString::fromUtf8("μOXID");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Oxids");
    case mBTC: return QString("Milli-Oxids (1 / 1,000)");
    case uBTC: return QString("Micro-Oxids (1 / 1,000,000)");
    default: return QString("???");
    }
}
