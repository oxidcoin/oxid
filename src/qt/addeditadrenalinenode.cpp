    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    //Labels
    ui->aliasLineEdit->setPlaceholderText("Enter Masternode unique name");
    ui->addressLineEdit->setPlaceholderText("Enter VPS IP & port (default port: 18932)");
    ui->privkeyLineEdit->setPlaceholderText("Enter Masternode private key");
    ui->txhashLineEdit->setPlaceholderText("Enter 5000 OXID TXID");
    ui->outputindexLineEdit->setPlaceholderText("Enter transaction output index");
    ui->rewardaddressLineEdit->setPlaceholderText("Enter a reward recive address (optional)");
    ui->rewardpercentageLineEdit->setPlaceholderText("Input the percentage for the reward (optional)");
}
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter the transaction hash for the 5000 OXID transaction (25000 OXID for supernodes)");
        msg.exec();
        return;
    }
