...
{
	resize(900, 600);
	setWindowTitle(tr("Oxid Coin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    // Title bar
	setObjectName("Oxid");
	setStyleSheet("#Oxid { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #e4e4e4);  }");
	// Accept D&D of URIs
	setAcceptDrops(true);
	...
	frameBlocksLayout->setContentsMargins(2, 0, 2, 0);
	...
	if (!fUseBlackTheme)
	{
		...
		{
			progressBar->setStyleSheet("QProgressBar { color: #000000;background-color: #e4e4e4; border: 1px solid grey; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: QLinearGradient(x1: 0, y1: 0, x2: 1, y2: 0, stop: 0 #FF8000, stop: 1 orange); border-radius: 7px; margin: 0px; }");
		}
	}
	...
	statusBar()->setStyleSheet("#statusBar { color: #000000; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #e4e4e4, stop: 1 #b7b7b7);  }");
...
void BitcoinGUI::createActions()
{
	...
	sendCoinsAction->setToolTip(tr("Send coins to a Oxid address"));
	...
	addressBookAction = new QAction(QIcon(":/icons/addresses"), tr("&Addresses"), this);
	...
	aboutAction = new QAction(QIcon(":/icons/bitcoin1"), tr("&About Oxid"), this);
	aboutAction->setToolTip(tr("Show information about Oxid"));
	aboutAction->setMenuRole(QAction::AboutRole);
	aboutQtAction = new QAction(QIcon(":/qt-project.org/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
	aboutQtAction->setToolTip(tr("Show information about Qt"));
	aboutQtAction->setMenuRole(QAction::AboutQtRole);
	optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
	optionsAction->setToolTip(tr("Modify configuration options for Oxid"));
	...
	signMessageAction = new QAction(QIcon(":/icons/messages"), tr("Sign &message..."), this);
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 15px; font-weight: 100; letter-spacing: 0.9px; font-family: Helvetica Neue, Helvetica; padding: 5px 5px 5px 30px; border: none; }"
		"QToolButton:hover { color: #ffffff; background-color: #3b3b3b; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { color: #ffffff; background-color: #4f4f4f; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { color: #ffffff; background-color: #4f4f4f; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"#tabs { color: #ffffff; background-color: #101010; border: none; padding-top: 0px; padding-bottom: 0px; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
	...
	if (clientModel)
	{
		...
		if (clientModel->isTestNet())
		{
			...
			if (trayIcon)
			{
				trayIcon->setToolTip(tr("Oxid client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
	...
	trayIcon->setToolTip(tr("Oxid client"));
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
	if (event->mimeData()->hasUrls())
	{
		...
		if (nValidUrisFound)
			...
			notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Oxid address or malformed URI parameters."));
	}
