...
private slots:
    ...
    QString BuyOXID(QString OrderType, double Quantity, double Rate);
    QString SellOXID(QString OrderType, double Quantity, double Rate);
