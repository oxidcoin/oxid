    ...
    walletModel(0)
{
	...
	ui->tableWidgetMasternodes->setColumnWidth(3, columnSupernodeWidth);
...
void MasternodeManager::updateNodeList()
{
    ...
    BOOST_FOREACH(CMasternode& mn, vMasternodes)
    {
		...
		//QTableWidgetItem* supernodeItem = new QTableWidgetItem(QString::number(mn.tier));
		...
		ui->tableWidgetMasternodes->setItem(0, 3, supernodeItem);
    ...
    BOOST_FOREACH(CMasternodeConfig::CMasternodeEntry mne, masternodeConfig.getEntries()) {
        ...
        BOOST_FOREACH(CMasternode& mn, vMasternodes) {
            if (mn.addr.ToString().c_str() == mne.getIp()){
                if (mn.tier == 2) {
                    updateAdrenalineNode(QString::fromStdString(mne.getAlias()), QString::fromStdString(mne.getIp()), QString::fromStdString(mne.getPrivKey()), QString::fromStdString(mne.getTxHash()),
                    QString::fromStdString(mne.getOutputIndex()), QString::fromStdString(strRewardAddress), QString::fromStdString(strRewardPercentage), QString::fromStdString("Supernode is Running."));
                } else {
                    updateAdrenalineNode(QString::fromStdString(mne.getAlias()), QString::fromStdString(mne.getIp()), QString::fromStdString(mne.getPrivKey()), QString::fromStdString(mne.getTxHash()),
