...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: Oxid.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: Oxidd.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeOxidamount=<n> " + _("Keep N Oxid anonymized (default: 0)") + "\n";
...
#ifdef ENABLE_WALLET
    if (mapArgs.count("-reservebalance")) // oxid: reserve balance amount
    {
