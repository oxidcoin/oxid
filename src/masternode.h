...
#define SUPERNODES_START_BLOCK                 5001 // Supernodes Starts at block
using namespace std;
using namespace boost::assign;

class CMasternode;

static const int64_t MASTERNODE_COLLATERAL =  5000;
static const int64_t SUPERNODE_COLLATERAL =   25000;

static const int64_t BASE_MASTERNODE_REWARD = 8;
static const int64_t BASE_SUPERNODE_REWARD =  48;
...
static std::map<int, int> masternodeCollateral = map_list_of (1, MASTERNODE_COLLATERAL) (2, SUPERNODE_COLLATERAL);

// Masternode rewards
static std::map<int, int> masternodeRewards = map_list_of (1, BASE_MASTERNODE_REWARD) (2, BASE_SUPERNODE_REWARD);
//
// The Masternode Class. For managing the darksend process. It contains the input of the 5000 OXID, signature to prove
