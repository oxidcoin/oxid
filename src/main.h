...
#define START_MASTERNODE_PAYMENTS_TESTNET 1531969200 // 19 July 2018
#define START_MASTERNODE_PAYMENTS 1531969200 // 19 July 2018 

static const int64_t DARKSEND_COLLATERAL = (0.01*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 4 * COIN;
...
static const int64_t MAX_MONEY = 89000000 * COIN;  // 89,000,000
...
int64_t GetHeightAdjustedMasternodeReward(int nHeight, int64_t baseMasternodePayment);
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // oxid: trust score of block chain
    int nHeight;
#ifndef LOWMEM
    int64_t nMint;
