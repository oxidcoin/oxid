...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\Oxid
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\Oxid
    // Mac: ~/Library/Application Support/Oxid
    // Unix: ~/.Oxid
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Oxid";
#else
    fs::path pathRet;
